...
void test5()
{
	BigData b1("10000000000000000000000000000000000");
	BigData b2("25");
	cout << b1/b2 << endl;
}
...
void test()
{
	...
	//"12345asdfg234567"    "asdf12345"
	//"000000000123456"    "0000000000000000"
	//"1234567"      ""
	cout << BigData("123456789") << endl;
	cout << BigData("+123456789") << endl;
	cout << BigData("-123456789") << endl;
	cout << BigData("1234aaass56789") << endl;
	cout << BigData("bbbb123456789") << endl;
	cout << BigData("000000123456789") << endl;
	cout << BigData("0000000000") << endl;
	cout << BigData("	     ") << endl;
	cout << BigData("	   56789") << endl;
	cout << BigData(-1998) << endl;
}


void test2()
{
	BigData b1("100000000000000000000000000000000");
	BigData b2("-22222222222");
	BigData b3("-100000000000000000000000000000000");
	BigData b4("22222222222");
	cout << b1 - b4 << endl;
	cout << b4 - b1 << endl;
	cout << b3 - b2 << endl;
	cout << b2 - b3 << endl;
